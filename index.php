...
$urls = ['communities', 'membership', 'downloads', 'sso', 'api', 'testingdetails', 'articles', 'communityprofiles', 'profiletypes', 'forums',
    ...
    'contact-us', 'savepost', 'search-results', 'products-and-services', 'product', 'test-suite', 'test-case', 'my-products',
    'test-suites', 'my-test-suites', 'my-communities', 'laravel-my-organisation', 'laravel-my-profile', 'members'
];
