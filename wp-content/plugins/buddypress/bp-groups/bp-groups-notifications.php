...
', 'buddypress' ), $requesting_user_name, $group->name, $group_requests, $requesting_user_name, $profile_link );
    ...
    /*********************************************************
    *****************  Change User Display Name to User ID by Eric********************* 
    * Add $requesting_user_id to the groups_notification_new_membership_request_subject filter params
    * 
    * Modify groups_notification_new_membership_request_message filter params
    * 
