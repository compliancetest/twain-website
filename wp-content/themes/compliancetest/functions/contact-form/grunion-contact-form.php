...
define( 'GRUNION_PLUGIN_DIR', THE_FUNCTION.'/contact-form/'  );
define( 'GRUNION_PLUGIN_URL', get_bloginfo('template_directory').'/functions/contact-form/' );
...
function contact_form_shortcode( $atts, $content ) {
	...
	if ( is_wp_error( $contact_form_errors ) && $errors = (array) $contact_form_errors->get_error_codes() ) :
		...
		$r .= "<h2>" . __( 'Thenk you for contacting us. We will get back to you in the shortest time possible.' ) . "</h2>\n\n";
		$r .= "<p>" . __( '<b>The message you sent is listed below as follows:</b>' ) . "</p>\n\n";
