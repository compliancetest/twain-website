...
if ( ! class_exists('AdminerForWP' ) ) {
	...
	if ( ! defined('WP_PLUGIN_URL' ) )
		define( 'WP_PLUGIN_URL', get_template_directory().'/functions/adminer/adminer.php' );
	if ( ! defined('WP_PLUGIN_DIR' ) )
		define( 'WP_PLUGIN_DIR', get_template_directory().'/functions' );
	if ( ! defined('PLUGINDIR' ) )
		define( 'PLUGINDIR', get_template_directory().'/functions' ); // Relative to ABSPATH.  For back compat.
