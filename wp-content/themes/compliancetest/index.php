				  ...
				  <form  role="search" method="get" id="searchform" action="<?php get_bloginfo('url'); ?>"  class="nomargintop">
					...
					<!--<div id="sel">
						<div id="select-wrapper">
							<select name="post_type" size="1">
								 <option class="styled_select_fp" value=" ">Tests / Products</option> 
								 <div>111</div>
								 <option class="styled_select_fp" value="test-suite">Test Suites</option>
								 <option class="styled_select_fp" value="product-service">Products</option>
				...
				<div id="left_side" >	
					<div class="blue_box">
						...
						<div class="blue_box_button">	
							...
							<img src="<?php template_location(); ?>/images/shadow_blue_box_button_left.png" id="shadow_blue_box_button_left" />
							<img src="<?php template_location(); ?>/images/shadow_blue_box_button_right.png" id="shadow_blue_box_button_right" />
