		...
		<div class="column nopaddingbottom">
							...
							<div class="tabs_wrap lighter_gray_bcg">
								<ul class="tabs_sv">
									...
									<li class="">
										<a href="javascript: void(0)" rel="tabs2" class="">
									...
									<li class="">
										<a href="javascript: void(0)" rel="tabs3" class="">
											<span class="left icon" id="icon_wiki"></span>
								...
								<div class="tab-content2 white_bcg" id="tabs2" style="display: none; ">
									<div class="column">
										<?php 
								...
								<div class="tab-content2 white_bcg" id="tabs3" style="display: none; ">
							...
							<div class="grid_cell width50P">
								<div id="three_boxes_sv"><a class="payment_popup">
									...
									<div id="box_2_blue" class="column third left">
										<h4>$200</h4>
										<p>per mounth</p>
									<img src="<?php template_location(); ?>/images/blue_box_left.png" id="box_shadow_blue_left">
									<img src="<?php template_location(); ?>/images/blue_box_right.png" id="box_shadow_blue_right">
									</div>
