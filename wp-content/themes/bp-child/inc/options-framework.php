...
function optionsframework_load_styles() {
	wp_enqueue_style('optionsframework', get_stylesheet_directory_uri().'/inc/css/optionsframework.css');
	wp_enqueue_style('color-picker', get_stylesheet_directory_uri().'/inc/css/colorpicker.css');
}	
...
function optionsframework_load_scripts($hook) {
	...
	wp_enqueue_script('color-picker', get_stylesheet_directory_uri().'/inc/js/colorpicker.js', array('jquery'));
	wp_enqueue_script('options-custom', get_stylesheet_directory_uri().'/inc/js/options-custom.js', array('jquery'));
