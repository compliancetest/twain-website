...
<div class="content" id="test_suite_coverage">
	...
	<div class="container">
        <div class="column">            
           ...
           <?php else: ?>
           <div>
                <p>This section shows the degree to which the transactions you have executed against <?php echo get_site_title();?> have satisfied the requirements of the test plans you have created for the products you are testing.</p>
...
<?php if( isset( $_SESSION['create_test_plan_error'] ) && $_SESSION['create_test_plan_error'] == true ):?>
    ...
    <div id="invalid_roles_levels" class="popup-box" style="display:none; width: 500px">
        ...
        <div class="popup-box-content">
            The pricing plan associated with this subscription does not cover the selected combination of role and conformance level. Please consult with your organisation's administrator within <?php echo get_site_title();?> to understand the available combinations.
        </div>
        <div class="popup-box-footer radius6 noradiustop">
