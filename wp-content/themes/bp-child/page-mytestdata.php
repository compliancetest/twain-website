                        ...
                        <div class="tr">
                           ...
                           <div class="td td-action">
                                ...
                                <?php if(count($subscriptions) > 0): ?>
                                    ...
                                    <?php else: ?>
                                            <?php if( ProfileInstance::isRun( $instance->profile_role ) ):?>
                                                <a href="javascript:void(0);" rel="custom-popup" cp-type="ajax" cp-removeBoxAfterClose=1 class="action-btn icon-btn blue-btn expand-btn left10 has-tooltip prepare_schedule trigger-btn greyed-out-btn"><span class="p"></span><span class="simple_tooltip radius6" style="width: 150px; left: -24px;">Trigger Run<span></span></span></a>
                                            <?php elseif( ProfileInstance::isSchedule( $instance->profile_role ) ):?>
                                                <a href="javascript:void(0);" rel="custom-popup" cp-type="ajax" cp-removeBoxAfterClose=1 class="action-btn icon-btn blue-btn expand-btn left10 has-tooltip prepare_schedule trigger-btn greyed-out-btn"><span class="p"></span><span class="simple_tooltip radius6" style="width: 150px; left: -24px;">Create a Run profile from this Schedule<span></span></span></a>
                                            <?php else:?>
