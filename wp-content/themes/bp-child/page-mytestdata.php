...
$doesGatewayConfigured = \User\User::isGatewayConfigured();
?>
                        ...
                        <div class="tr">
                           ...
                           <div class="td td-action">
                                ...
                                <?php if(count($subscriptions) > 0): ?>
                                    ...
                                    <?php endif;?>
                                    <a href="<?php echo S3Wrapper::getProfileLink( $instance->token, $instance->profile_name, true );?>" class="action-btn icon-btn download-btn has-tooltip"><span class="p"></span><span class="simple_tooltip radius6">Download Profile<span></span></span></a>
                                    <?php if( ProfileInstance::isSchedule( $instance->profile_role ) && $instance->validation_status == 'valid' && $doesGatewayConfigured && $doesPricingPlanSupportBulk):?>
                                    ...
                                    <?php elseif( ProfileInstance::isRun( $instance->profile_role ) && $doesPricingPlanSupportBulk && ProfileInstance::isRunCanBeTriggered( $instance->token ) && $doesGatewayConfigured ):?>
                                    ...
                                    <?php elseif( $sqs_validation_enabled && $instance->is_expanded == 0 && $instance->validation_status == 'valid' && in_array( str_replace( ' ', '', $instance->profile_role ), ProfileType::getExpandableTypes() ) ): ?>
                                        <a href="#create-expanded-version" data-id="<?php echo $instance->id;?>" class="action-btn icon-btn blue-btn expand-btn has-tooltip create_expanded_version"><span class="p"></span><span class="simple_tooltip radius6">Create Expanded Version of this profile<span></span></span></a>
                                    <?php else: ?>
                                            <?php if (ProfileInstance::isRun( $instance->profile_role )):?>
                                                <a href="javascript:void(0);" class="action-btn icon-btn blue-btn expand-btn has-tooltip trigger-btn greyed-out-btn"><span class="p"></span><span class="simple_tooltip radius6" style="width: 150px; left: -24px;">Trigger Run<span></span></span></a>
                                            <?php elseif( ProfileInstance::isSchedule( $instance->profile_role ) ):?>
                                                <a href="javascript:void(0);" class="action-btn icon-btn blue-btn expand-btn has-tooltip trigger-btn greyed-out-btn"><span class="p"></span><span class="simple_tooltip radius6" style="width: 150px; left: -24px;">Create a Run profile from this Schedule<span></span></span></a>
                                            <?php else:?>
                                                <a href="javascript:void(0);" class="action-btn icon-btn blue-btn expand-btn has-tooltip greyed-out-btn"><span class="p"></span><span class="simple_tooltip radius6">Create Expanded Version of this profile<span></span></span></a>
                                            <?php endif;?>
                                    <?php endif; ?>
                                    ...
                                    <?php endif; ?>
                                    <a href="<?php echo get_site_url()?>?td-action=<?php echo wp_create_nonce('edit-tags')?>&id=<?php echo $instance->id?>" rel="custom-popup" cp-type="ajax" data-id="<?php echo $instance->id?>" data-type-id="<?php echo $instance->type_id?>" class="action-btn icon-btn tags-btn has-tooltip"><span class="p"></span><span class="simple_tooltip radius6">Edit Tags<span></span></span></a>
                                <?php endif; ?>
    ...
    <form name="editProfileErrorForm" id="editProfileErrorForm" action="" method="post" style="display: none;">
        ...
        <div class="popup-box-footer radius6 noradiustop">                            
            <div class="btn-row">
                ...
                <a href="#" class="action-btn view-profile-type-box right" id="download-error"><span class="p"></span><span class="t">Download</span></a>
                <div class="clear"></div>
            </div>
        </div>                        
        <a class="close_btn"></a>                        
