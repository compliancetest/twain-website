                           ...
                           <div class="td td-action">
                                ...
                                <?php if(count($subscriptions) > 0): ?>
                                    ...
                                    <?php elseif( ProfileInstance::isRun( $instance->profile_role ) && $instance->validation_status == 'valid' ):?>
                                        <a href="<?php echo the_permalink() ?>?td-action=<?php echo wp_create_nonce('trigger_run')?>&id=<?php echo $instance->id?>" rel="custom-popup" cp-type="ajax" cp-removeBoxAfterClose=1 class="action-btn icon-btn blue-btn expand-btn left10 has-tooltip prepare_schedule trigger-btn"><span class="p"></span><span class="simple_tooltip radius6" style="width: 150px; left: -24px;">Trigger Run<span></span></span></a>
