...
<?php if ( bbp_current_user_can_access_create_topic_form() ) : ?>
	...
	<div id="new-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-form">
		...
		<div>
            ...
            <p class="field-row">
				<label for="bbp_topic_title"><?php printf( __( 'Topic Title <small>(Maximum Length: %d)</small>:', 'bbpress' ), bbp_get_title_max_length() ); ?></label>
			...
			<div class="bbp-submit-wrapper">
				...
				<input type="hidden" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button submit" /> 
