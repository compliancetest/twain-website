...
<ul class="tabs <?php echo $isMember ? 'no-ajax' : '' ?>">
    <li class="<?php echo (bp_current_action() == 'home' || bp_current_action() == '') ? 'active' : '' ?>">
        <a href="<?php echo bp_get_group_permalink() ?>" rel="testsuites-container"
           class="<?php echo (bp_current_action() == 'home' || bp_current_action() == '') ? 'selected' : '' ?>">
    ...
    <li class="<?php echo (bp_current_action() == 'testdata') ? 'active' : '' ?>">
        <a href="<?php echo bp_get_group_permalink() ?>testdata" rel="testdata-container"
           class="<?php echo (bp_current_action() == 'testdata') ? 'selected' : '' ?>">
    ...
    <li class="<?php echo (bp_current_action() == 'wiki') ? 'active' : '' ?>">
        <a href="<?php echo bp_get_group_permalink(); ?>wiki" rel="wiki-container"
           class="<?php echo (bp_current_action() == 'wiki') ? 'selected' : '' ?>">
    ...
    <li class="<?php echo (bp_current_action() == 'forum') ? 'active' : '' ?>">
        <a href="<?php echo bp_get_group_permalink() ?>forum" rel="forum-container"
           class="<?php echo (bp_current_action() == 'forum') ? 'selected' : '' ?>">
    ...
    <li class="<?php echo (bp_current_action() == 'downloads') ? 'active' : '' ?>">
        <a href="<?php echo bp_get_group_permalink() ?>downloads" rel="downloads-container"
           class="<?php echo (bp_current_action() == 'downloads') ? 'selected' : '' ?>">
    ...
    <li class="<?php echo (bp_current_action() == 'reports') ? 'active' : '' ?>">
        <a href="<?php echo bp_get_group_permalink() ?>reports" rel="reports-container"
           class="<?php echo (bp_current_action() == 'reports') ? 'selected' : '' ?>">
    ...
    <?php if (bp_group_is_admin()) { ?>
        <li class="<?php echo (bp_current_action() == 'admin') ? 'active' : '' ?>">
            <a href="<?php echo bp_get_group_permalink() ?>admin" rel="group_admin_page"
               class="<?php echo (bp_current_action() == 'admin') ? 'selected' : '' ?>">
