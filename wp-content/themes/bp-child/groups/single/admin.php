                       ...
                       <div class="tbody">
                            ...
                            <div class="tr">
                               ...
                               <div class="td td-profile-action">
                                   <a href="<?php echo bp_get_group_admin_permalink()?>?td-action=<?php echo wp_create_nonce('edit-profile-type')?>&type_id=<?php echo $row->id?>&community_id=<?php echo bp_get_group_id()?>" class="action-btn blue-edit-btn icon-btn profile-type-edit-btn"><span class="p"></span><span class="simple_tooltip radius6">Edit Profile Type<span></span></span></a>
                                   <a href="<?php echo bp_get_group_admin_permalink()?>?td-action=<?php echo wp_create_nonce('delete-profile-type')?>&type_id=<?php echo $row->id?>&community_id=<?php echo bp_get_group_id()?>" class="action-btn blue-delete-btn icon-btn left10 profile-type-delete-btn"><span class="p"></span><span class="simple_tooltip radius6">Remove Profile Type<span></span></span></a>
                               </div>     
                               <div class="clear"></div>                               
                            </div>
                            <?php } ?>
