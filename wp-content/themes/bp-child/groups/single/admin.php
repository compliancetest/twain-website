                       ...
                       <div class="tbody">
                            ...
                            <div class="tr">
                               ...
                               <div class="td td-profile-action">
                                   <a href="<?php echo bp_get_group_admin_permalink()?>?td-action=<?php echo wp_create_nonce('download-profile-type')?>&type_id=<?php echo $row->id?>" class="action-btn icon-btn download-btn"><span class="p"></span><span class="simple_tooltip radius6 no-wrap">Download Profile Type<span></span></span></a>
