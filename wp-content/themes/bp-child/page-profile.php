	...
	<div class="four_fifths right container">
        ...
        ?>
          <?php if($user_status == 3){?>
                <div class="inner-warning">Your email is not verified yet, please check your email address! <span>(resend email <a id="resend_email_verification" href="<?php echo get_site_url()?>?cp_action=<?php echo wp_create_nonce('resend_email_verification')?>" data-email="<?php echo $current_user->user_email?>">link verification</a>)</span></div>
            <?php }?>
