...
?>
        ...
        <div class="expandable">
            ...
            <div class="exp_content">
                ...
                foreach ($postTypes as $ptype) {
                    ?><a
                    href="<?php echo get_post_type_archive_link($ptype) ?>" <?php if ($postType == $ptype){ ?>class="current"<?php } ?>><?php echo $wp_post_types[$ptype]->labels->name ?></a><?php
                }
                ?>
            </div>
        </div>
    ...
    <script>
        jQuery(document).ready(function () {
            jQuery('.content').height(jQuery('.content').height() + 100)
        });
    </script>
<?php
