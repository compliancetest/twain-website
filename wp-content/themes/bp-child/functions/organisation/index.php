                            ...
                            <div class="grid-cell">
                                ...
                                <select id="pricing_plan_id" class="pricing_plan_id">
                                    ...
                                    <?php foreach( $suite->test_suite_plans AS $pp ):?>
                                        ...
                                        <option value="<?php echo $pricing_plan->id;?>"<?php if( $pricing_plan->id == $subscription->pricing_plan_id ): $is_shown = true;?> selected="selected"<?php endif;?> ><?php echo $pricing_plan->title;?></option>
                                    <?php endforeach;?>
                                    <?php if( ! $is_shown ):?>
                                        <?php $pricing_plan = new PricingPlan( $subscription->pricing_plan_id );?>
                                        <option value="<?php echo $subscription->pricing_plan_id;?>" selected="selected"><?php echo $pricing_plan->title;?></option>
                                    <?php endif;?>
                                </select>
            ...
            if (!$subscription || !$user_id || !ct_is_organisation_admin($user_id, $subscription->organisation_id)) {
                ...
                <div class="popup-box" id="unsubscription-confirm-box" style="display: none; width: 450px;">
                    <form name="unsubscribe-form" action="/index.php" method="post">
                        ...
                        <div class="popup-box-footer radius6 noradiustop">              
                            <label class="left">
                                <input type="checkbox" id="delete-now" name="delete-now" <?php if($subscription->status == 'Unsubscribing' || !DISPLAY_SUBSCRIPTIONS){ ?> disabled="disabled" checked="checked" <?php } ?> /> Cancel immediately
                            </label>
                            <div class="right">
                                <a href="#" class="action-btn process-btn submit-btn"><span class="p"></span><span class="t">Confirm</span></a>
                                <a href="#" class="action-btn cancel-btn close-popup-btn"><span class="p"></span><span class="t">Cancel</span></a>            
