...
$ct_email_templates = array(
    ...
    'Organisation Section' => array(
        array(
            ...
            'title'         => 'Send a Organisation Record Created to Site Admin',
                            ...
                            <table class="widefat">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" size="50" name="<?php echo $tf['id']?>_email_title" id="<?php echo $tf['id']?>_email_title" value="<?php echo get_option($tf['id'] . '_email_title')?>" />
                                        </td>
                                    </tr>
                                    <tr>
