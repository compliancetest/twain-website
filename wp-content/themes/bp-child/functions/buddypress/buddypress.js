(function ($) {
    $(document).ready(function () {
        ...
        $('.community-registration-box .process-btn').on('click', function () {
            ...
            if (!form.find('#agree_community_terms').prop('checked')) {
        ...
        $('.community-terms-box .cancel-btn').click(function () {
            $('#community-registration' + $(this).attr('data-id') + ' #agree_community_terms').prop('checked', false);
            $('#groupbutton-' + $(this).attr('data-id') + ' a.join-community-button').click();
            return false;
        })
        ...
        $('.community-license-box .cancel-btn').click(function () {
            $('#community-registration' + $(this).attr('data-id') + ' #agree_community_license').prop('checked', false);
            $('#groupbutton-' + $(this).attr('data-id') + ' a.join-community-button').click();
            return false;
        })
    })
