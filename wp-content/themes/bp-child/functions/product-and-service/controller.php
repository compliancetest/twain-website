    ...
    if (wp_verify_nonce($action, 'save-product-service')) {
        ...
        <div id="delete_search_entry" class="popup-box deleting-case-confirm-box" style="display: none; width: 450px">
            ...
            <div class="popup-box-footer radius6 noradiustop">
                <a class="action-btn process-btn submit-btn delete_search_entry_confirm" href="#" data-id="<?php echo $_REQUEST['id']; ?>"
                   data-type="<?php echo isset($_REQUEST['t']) && $_REQUEST['t'] == '2' ? 'site' : 'registry'; ?>"><span class="p"></span><span class="t">Confirm</span></a>
...
function deleteProduct()
{
    ...
    if($transactions || $claims || $testPlans){
        addMessage("You can't delete this product. Please delete claims, test plans and test results associated with product and try again.", 'error');
        exit('error');
    }
