...
class Pricing_Plans_List_Table extends WP_List_Table
{
    var $per_pages = 20;
    ...
    function get_sortable_columns( $orderby )
    {
        return $sortable = array(
            "id_str"      => array("id_str", $orderby == 'id_str'),
            "title"       => array("title", $orderby == 'title'),
...
//        );
    ...
    function column_default($item, $column_name)
    {
        ...
        {
            case 'title':
                return "<a href='admin.php?page=view-pricing-plan&org-action=" . $item->id . "'>".$item->title."</a>";
            default:
    ...
    function prepare_items()
    {
        ...
        $query = "SELECT count(*) FROM {$wpdb->prefix}pricing_plans";
        ...
        $query  = "SELECT * FROM {$wpdb->prefix}pricing_plans ";
