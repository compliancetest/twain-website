...
class CloudSearch
{
    ...
    public function __construct()
    {
        ...
        if( ! $this->_client ) {
            ...
            set_transient('cloud_search_object', $this->_client, 300);
        }
    }
    ...
    {
        $domainName = get_option('cloudsearch_domain_name');
    ...
    public static function configureFields()
    {
        ...
        if (!empty($result->getPath('DomainStatusList'))) {
            ...
            $client->defineIndexField(array(
                'DomainName' => $domainName,
                'IndexField' => array(
                    'IndexFieldName' => 'e2e_partner_service_id',
