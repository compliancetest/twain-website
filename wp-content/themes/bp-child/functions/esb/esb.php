...
//                    $orderQuery .= ' ORDER BY FROM_PARTY_ID ' . $order;
        ...
        if($ids)
        {
            $query = "SELECT
                        ...
                        m.ORIGINAL_MESSAGE_ID, m.REF_TO_MESSAGE_ID, m.PART_ID, m.ATTACHMENT_ID, m.UPLOAD_ID, m.S3_ENVELOPE, m.CT_RECEIPT_MESSAGE_ID, m.GATEWAY_RECEIPT_MESSAGE_ID, m.FLAG,
