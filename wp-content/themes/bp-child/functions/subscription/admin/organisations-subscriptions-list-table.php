...
//        );
    ...
    function prepare_items()
    {
        ...
        $query = "SELECT distinct(os.id), os.nickname, os.organisation_id, os.purchaser_id, os.purchased_date, os.status, os.suite_minor_family_mark, os.payment_method, os.user_id, o.organisation_name, t.suite_title, p.nickname AS payment_method_name, p.invoice_me, p.card_number FROM {$wpdb->prefix}organisations_subscriptions as os
