...
function compliancetest_create_new_user()
{
    ...
    if (is_wp_error($user_id)) {
        ...
        wp_update_user(array('ID' => $user_id, 'first_name' => remove_special_chars(trim($_POST['first_name'])), 'last_name' => remove_special_chars(trim($_POST['last_name']))));
        ...
        if ($invitationData) {
            $communityAdmins = getCommunityAdmins($invitationData->community_id);
            ...
            <div id="top_acces_wrap">
                <div id="top_loged_actions">
                    <ul>
                        ...
                        <li>
                            <a class="red-btn action-btn icon-btn signup-btn popup"
                               href="/register">
                                <span class="p"></span>
