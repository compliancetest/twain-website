                            ...
                            <div class="existing_user">
                                ...
                                <form id="formreg" action="" method="post">
                                    ...
                                    <div class="field top23">        
                                        <input type="checkbox" name="acc_tc" id="acc_tc_id"><label for="acc_tc">I accept the compliancetest.net <a href="<?php echo get_bloginfo('url');?>/terms-conditions" id="terms_co">Terms & Conditions.</a></label>
                                    </div>
                                    <div class="clear"></div>
