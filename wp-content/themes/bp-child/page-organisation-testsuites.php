...
?>
                            ...
                            <div class="grid-box-body">
                                ...
                                <div class="tbody">
                                    ...
                                    if (count($subscriptions) < 1) {
                                        ...
                                        <span
                                            class="status_btn status_<?php echo strtolower($row->status) ?> has-tooltip">
                                            <?php echo $row->status ?>
    ...
    <div class="popup-box" id="subscribe-box" style="display: none;">
        <form name="paymentForm" id="paymentForm" action="" method="post">
            ...
            <div class="popup-box-content grid-box-body">
                ...
                <div class="field-row">
                    <div class="grid-cell">
                        ...
                        <a href="<?php echo the_permalink() ?>?_organisation_nonce=<?php echo wp_create_nonce('get_price_plan') ?>&suite_id=1"
                           class="submit_all" rel="custom-popup" cp-type="ajax" cp-closeWhenClickOveraly=0
                           cp-removeBoxAfterClose=1><span class="p"></span><span
                                class="t">View Pricing Plan Details</span></a>
                        <script>
                ...
                <div class="field-row notice-txt">
                    <div class="grid-cell">
                        <input type="checkbox" name="agree_terms" value="agree" id="agree_customer_terms"> I agree with
                        the <a href="<?php echo home_url(); ?>/customer-tc/" target="_blank">Terms & Conditions</a>
                    </div>
                    <div class="clear"></div>
                </div>
            </div>
            ...
            ?>
            <div class="loading loading-with-text">
                <div><b>LOADING DATA</b><span>Please wait...</span></div>
            </div>

            <div class="popup-box-footer radius6 noradiustop">
                <a href="#" class="action-btn process-btn submit-btn"><span class="p"></span><span
                        class="t">Submit</span></a>
            ...
            <select id="all_family_mark" style="display: none;">
                ...
                <?php foreach ($test_suites as $row) { ?>
                    ...
                    <?php if (!empty($_pricing_plan)): ?>
                        <option value="<?php echo $row->suite_id ?>"
                                community-id="<?php echo get_post_meta($row->suite_id, 'community_id', true) ?>">
                            <?php echo $row->suite_title ?>
                        </option>
                    <?php endif; ?>
                <?php } ?>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            jQuery('.td-status .simple_tooltip').each(function () {
                jQuery(this).css({
                    'top': -1 * jQuery(this).outerHeight() - 6,
                    'margin-left': -1 * jQuery(this).outerWidth() / 2 + jQuery(this).parent().outerWidth() / 2
                });
            })
