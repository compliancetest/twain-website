                   ...
                   <?php
                       ...
                       if(!$claims){
                           ...
                           <div class="tr">
                               ...
                               <div class="td td-certificate"><a href="javascript: void;" onclick="window.open('<?php echo get_site_url()?>/claims/<?php echo $claim->token?>.pdf', '', 'height=600')">View PDF</a></div>
