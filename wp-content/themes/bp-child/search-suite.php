    ...
    <div class="content container" id="search">
        <div id="search_title_block" class="page-title-block column noshadow">
            ...
            <?php if (count($params) > 0) { ?>
                <a href="<?php echo get_permalink() ?>" class="action-btn delete-grey-btn" id="clear-search-filter-btn"><span
                        class="p"></span><span class="t">Clear All</span></a>
            <?php } ?>
            <div class="clear"></div>
                            ...
                            <div class="expandable">
                                ...
                                <div class="exp_content">
                                    ...
                                    foreach ($tsIssueYears as $k => $v) {
                                        ?>
                                        <label for="<?php echo $k ?>" class="blue_txt"><input type="checkbox"
                                                                                              name="issue_year[]" <?php echo in_array($k, $filterYear) ? 'checked="checked"' : '' ?>
                                                                                              value="<?php echo $k ?>"
                                                                                              id="<?php echo $k ?>"
                                                                                              class="input_filter"> <?php echo $k ?>
                                            (<?php echo $v ?>)</label>
