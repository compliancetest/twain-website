...
<div class="content container">
    ...
    <div id="suite-detail-popup" style="width: 900px" class="popup-box">
        ...
        <div class="popup-box-content">
            <?php } ?>
            <div class="infos">
                <h3 class="dark_gray_txt normal left">Test case: <span
                        class="dark_blue_txt bold"><?php echo $case->title; ?></span></h3>
                <?php
                if (can_edit_test_case($case->id)) {
                    ?>
                    <a href="/edit-test-case?id=<?php echo $case->id ?>" class="action-btn edit-btn left10"><span
                            class="p"></span><span class="t">Edit</span></a>
                    <?php
                }
                ?>
                ...
                <div class="grids noradiusbottom">
                    <div class="grid_row white_bcg noborderbottom">
                        ...
                        <div class="grid_cell width20P left">
                            <p>Status:
                                <span
                                    class="status_btn status_<?php echo sanitize_title($case->status) ?>"><?php echo $case->status ?></span>
                            </p>
                        </div>
                    ...
                    <div class="grid_row white_bcg noborderbottom">
                        ...
                        <div class="grid_cell width15P left">
                            <div class="test-pattern">
                                ...
                                <p>Test Pattern:</p>
                                <a href="<?php echo get_site_url() ?>/help-faq/test-patterns/"
                                   class="test-pattern-icon test-pattern-<?php echo $case->testPattern; ?> has-tooltip"><span
                                        class="simple_tooltip"><?php echo $test_patterns_description; ?>
                                        <span></span></span></a>
                            </div>
                        </div>
                    ...
                    <div class="grid_cell width100P toleft">
                        ...
                        <div class="grids noradiusbottom padding20-10">
                            ...
                            <a href="<?php echo get_site_url() ?>?td-action=<?php echo wp_create_nonce('view-profile-instance') ?>&id=<?php echo $instance->id ?>"
                               class="view-profile-instance-link"><?php echo $instance->profile_name; ?></a>
                        </div>
                        ...
                        <div class="grids message-sample">
                            <div class="grid_row white_bcg padding5-10">
                                <div class="grid_cell width20P">
                                    <select class="select" id="message-template">
                                        <?php foreach ($case->messageTemplates as $key => $row): ?>
                                            <option
                                                value="<?php echo base64_encode($row['url']) ?>"><?php echo $row['name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <?php
                                ...
                                <div class="grid_cell width20P left5P actions-column">
                                    <a href="/view-message-template?mode=xml" target="_blank"
                                       class="view-message-template" data-mode="xml">XML</a> | <a
                                        href="/view-message-template?mode=html" target="_blank"
                                        class="view-message-template" data-mode="html">HTML</a>
                                </div>
                                <div class="clear"></div>
                            </div>
                        </div>
                ...
                <div class="grid_cell width100P toleft">
                    ...
                    <div class="grids redactor_editor">
                        ...
                        foreach ($case->testSteps as $key => $row) {
                            ?>
                            <div class="grid_row white_bcg padding5-10" id="step_anchor_<?php echo($key + 1); ?>">
                                ...
                                <div
                                    class="grid_cell width35P left5P"><?php echo _convertLineSymbolToBR($row['result']); ?></div>
                                <div class="clear"></div>
                            </div>
                            <?php
                        } ?>
            ...
            <div class="clear"></div>
            <script src="/wp-content/themes/bp-child/js/jquery.magnific-popup.js"></script>
