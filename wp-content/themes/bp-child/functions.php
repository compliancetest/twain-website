...
define('MESSAGE_WARNING_ANONYMOUS', 'You must be a registered member of the site to view this content. Registration is free - just go to the '.get_option('tw_site_title').' home page and click on the Signup button.');
