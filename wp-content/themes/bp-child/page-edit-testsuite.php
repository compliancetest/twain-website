                   ...
                   <div class="field-row">
                       <div class="grid-cell">
                           <select name="community_id" id="community_id" class="select">
                               ...
                               <option value="<?php echo $row->id?>" <?php echo cp_selected($row->id, $suite->community_id)?>><?php echo $row->title?></option>
                               <?php } ?>
                           </select>                           
                       </div>
                       <div class="clear"></div>
               ...
               <div class="column">
                   ...
                   foreach($profileTypes as $row){ ?>
                       ...
                       <div class="grid-cell width50P nopadding">                           
                               ...
                               <a href="<?php echo get_site_url()?>?td-action=<?php echo wp_create_nonce('view-profile-type')?>&id=<?php echo $row->id?>" rel="custom-popup" cp-type="ajax">
                                   <?php echo $row->title?>
                                   <?php
