<form action="<?php bp_messages_form_action('compose'); ?>" method="post" id="send_message_form" class="standard-form" role="main" enctype="multipart/form-data">
	...
	<div class="submit">
		<input type="hidden" value="<?php _e( "Send Message", 'buddypress' ); ?>" name="compose-message" id="compose-message" />
        <a href="#" class="action-btn submit-btn process-btn"><span class="p"></span><span class="t">Send Message</span></a>
        <?php if (1 || bp_current_user_can( 'bp_moderate' ) ) : ?>
