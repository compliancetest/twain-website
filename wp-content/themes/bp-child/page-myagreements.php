...
<div class="content" id="my-agreements">
    ...
    <div class="container">
        <div class="column">
           ...
           <a href="/add-new-product-and-service" class="action-btn add-new-btn"><span class="p"></span><span class="t">New Service</span></a>
           <div class="clear"></div>
           ...
           <div class="grid-box table-box grid-box-opened">
               <div class="grid-box-header">
                   <div class="grid-box-header-title left">
                       <ul>
                           <li>Service: <a href="#"><strong>Contributions v1.2</strong></a></li>
                           <li>Entity: <strong>MLC Super</strong></li>
                           <li>USI: <strong>1234567:123</strong></li>
                           <li>Role: <strong>Fund</strong></li>
                           <li>User Product: <strong>MLC Registry 1.0</strong></li>
                       </ul>
                   </div>
                   ...
                   <a class="gbh-btn gbh-btn-edit right has-tooltip" href="#" title="Edit">Edit</a>
                   <?php } ?>
