                ...
                <tr>
                    ...
                    <td class="text-center">
                        @if($explainRequestsEnabled)
                            ...
                            <span class="tooltip-wrapper" data-toggle="tooltip" data-trigger="hover" title="Request Status Explanation">
                        ...
                        @if(isImageViewerEnabled())
                            <span class="tooltip-wrapper" data-toggle="tooltip" data-trigger="hover" title="Image Viewer">
