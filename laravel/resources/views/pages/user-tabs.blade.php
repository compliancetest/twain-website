<div class="tabs-menu">
    <ul>
        ...
        <li class="coverage-tab"><a href="/test-suite-coverage/" @if($tab == 'test-suite-coverage') class='active' @endif data-tooltip="tooltip" title="Completeness of my testing">Coverage</a></li>
        <li class="coverage-tab"><a href="/verify-requests/" @if($tab == 'verify-requests') class='active' @endif data-tooltip="tooltip" title="My Verify Test Results Requests">Verify Requests</a></li>
        ...
        @if(is_super_admin())
            <li class="transactions-tab"><a href="/api-logs/" @if($tab == 'api-logs') class='active' @endif data-tooltip="tooltip" title="ApiLogs">ApiLogs</a></li>
            <li class="transactions-tab"><a href="/test-outcome-logs/" @if($tab == 'test-outcome-logs') class='active' @endif data-tooltip="tooltip" title="Outcome Logs">Outcome Logs</a></li>
        @endif
    </ul>
</div>