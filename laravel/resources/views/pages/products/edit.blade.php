            ...
            <div class="edit-product">
                <div class="colored-box">
                    ...
                    <div class="colored-box-body">
                        {!! Form::model($product, ['id'=> 'edit-product-form', 'data-save-method' => 'ajax', 'data-redirect-after-submit' => '/product/' . $product->slug, 'method' => 'POST', 'url' => getSiteUrl() . '/product/'.$product->slug]) !!}
