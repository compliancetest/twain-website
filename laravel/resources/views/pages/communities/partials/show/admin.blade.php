<div class="community-admin">
    ...
    <div class="tab-content community-tab-content">
        @if($community->isAdmin())
        <div role="tabpanel" class="tab-pane active" id="settings-base">
            <div class="row">
                <div class="col-sm-6">
        ...
        <div role="tabpanel" class="tab-pane" id="settings-test-data">
            <div class="colored-box">
        ...
        <div role="tabpanel" class="tab-pane @if($community->isModerator()) active @endif" id="settings-members">
        ...
        <div role="tabpanel" class="tab-pane" id="settings-testing-approved">
            <div class="colored-box">
        ...
        <div role="tabpanel" class="tab-pane" id="settings-extra">
            <div class="colored-box">
