        ...
        <div class="main-content">
            ...
            <div class="tab-content sub-tabs-content block-loading-wrapper">
                <div role="tabpanel" class="tab-pane active" id="organisation-users">
                            ...
                            <div class="table-responsive">
                                <table class="table colored-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Super Admin</td>
                                            <td>preproduction@mailinator.com</td>
                                            <td class="text-center">Admin</td>
                                            <td class="text-center">
                                                <a href="#modalRemoveMember" data-toggle="modal" class="btn btn-danger btn-icon btn-delete" data-tooltip="tooltip" title="Delete Member"></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="modal fade profile-modal" id="modalRemoveMember" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a data-dismiss="modal" href="#" class="btn btn-success btn-with-icon btn-confirm">Confirm</a>
                            ...
                            <div class="table-responsive">
                                <table class="table colored-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>TWAIN</td>
                                            <td>TWAIN v2.2 Compliance - Data Sources v1.0 </td>
                                            <td>twainds22-v1-0-1 </td>
                                            <td></td>
                ...
                <div role="tabpanel" class="tab-pane" id="organisation-profile">
                    {!! Form::model($community, ['id'=> 'saveOrganizationForm', 'data-ajax-form'=>'true', 'data-notification-container'=>'.error-box', 'data-validate' => 'validate', 'method' => 'POST', 'url' => getSiteUrl() . '/laravel-my-organisation/save']) !!}
                        <div class="row">
                            <div class="col-sm-6">
                                    ...
                                    <div class="colored-box-body">
                                        <div class="colored-box-content">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="organisationName" name="name" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group" id="organisation-key-row">
                                                <label for="organisationKey">Key:</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" readonly id="organisationKey" value="347680db975ed172473422bcdb00a168" />
                                                    <span class="input-group-btn">
                                                        <button type="button" class="btn btn-success copyOrgKeyLink" data-clipboard-target="#organisationKey" data-tooltip="tooltip" title="Copy to Clipboard">Copy Key</button>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" class="form-control organisation-description" id="organisationDescription" name="organisation_description"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="organisationWebsite">Website:</label>
                                                <input type="url" id="organisationWebsite" name="organisation_website" class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="colored-box-body">
                                        <div class="colored-box-content">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="primaryContactFirstName" name="primary_contact_first_name" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="primaryContactLastName">Last Name:</label>
                                                <input type="text" id="primaryContactLastName" name="primary_contact_last_name" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="primaryContactEmail">Email:</label>
                                                <input type="email" id="primaryContactEmail" name="primary_contact_email" class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="colored-box-body">
                                        <div class="colored-box-content">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="secondaryContactFirstName" name="secondary_contact_first_name" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="secondaryContactLastName">Last Name:</label>
                                                <input type="text" id="secondaryContactLastName" name="secondary_contact_last_name" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="secondaryContactEmail">Email:</label>
                                                <input type="email" id="secondaryContactEmail" name="secondary_contact_email" class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="colored-box-body">
                                        <div class="colored-box-content">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="billingAddressAttention" name="billing_address_attention" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="billingAddressLine1">Address Line 1:</label>
                                                <input type="text" id="billingAddressLine1" name="billing_address_line_1" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="billingAddressLine2">Address Line 2:</label>
                                                <input type="text" id="billingAddressLine2" name="billing_address_line_2" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="billingAddressLine3">Address Line 3:</label>
                                                <input type="text" id="billingAddressLine3" name="billing_address_line_3" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="billingAddressLine4">Address Line 4:</label>
                                                <input type="text" id="billingAddressLine4" name="billing_address_line_4" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="billingAddressCity">City:</label>
                                                <input type="text" id="billingAddressCity" name="billing_address_city" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="billingAddressState">State:</label>
                                                <input type="text" id="billingAddressState" name="billing_address_state" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="billingAddressPostalCode">Postal Code:</label>
                                                <input type="text" id="billingAddressPostalCode" name="billing_address_postal_code" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="billingAddressCountry">Country:</label>
                                                <input type="text" id="billingAddressCountry" name="billing_address_country" class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="colored-box-body">
                                        <div class="colored-box-content">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="billingTelephoneCountryCode" name="billing_telephone_country_code" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="billingTelephoneAreaCode">Area Code:</label>
                                                <input type="text" id="billingTelephoneAreaCode" name="billing_telephone_area_code" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="billingTelephoneNumber">Number:</label>
                                                <input type="tel" id="billingTelephoneNumber" name="billing_telephone_number" class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="colored-box-body">
                                <div class="colored-box-content">
                                    <div class="row">
                                        <div class="col-sm-7">
                                            <div class="form-group">
                                                <textarea rows="2" id="manufacturerListAliases" name="manufacturer_list_aliases" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
