                                    ...
                                    <td class="col-sm-1 text-nowrap text-center">
                                        @if(!\App\Transaction::where(['product_id' => $userPlan['product']->ID, 'test_suite_id' => $userSuite['testSuite']->ID])->get()->isEmpty())
                                            <a href="/my-transaction-log/?test_suite_id={{ $userSuite['testSuite']->ID }}&product_id={{ $userPlan['product']->ID }}" target="_blank"
                                               class="btn btn-primary btn-icon btn-view" data-tooltip="tooltip" data-container="body" title="View log"></a>
                                        @endif
                                        ...
                                        <a href="#removePlanModal-{{ $userPlan['testPlan']->id }}" data-toggle="modal" class="btn btn-danger btn-icon btn-delete"
                                           data-tooltip="tooltip" data-container="body" title="Delete plan"></a>
