...
class TestCasesController extends BaseApiController
{
    ...
    /**
     * @api {get} /v2/testcase Request Test Execution profile
     * @apiVersion 2.0.0
     *
    ...
    /**
     * @api {get} /v2/testcases/:test_case_id/profiles Request Test Case profiles
     * @apiVersion 2.0.0
     *
     * @apiName getProfiles
     * @apiGroup Test Cases
    ...
    /**
     * @api {post} /v2/testcase/start Set testing details
     * @apiVersion 2.0.0
     *
    ...
    /**
     * @api {delete} /v2/testcase/stop Delete testing details
     * @apiVersion 2.0.0
     *
    ...
    /**
     * @api {get} /v2/testcase/status Get testing details
     * @apiVersion 2.0.0
     *
