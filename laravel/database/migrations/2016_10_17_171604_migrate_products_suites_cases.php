...
class MigrateProductsSuitesCases extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('test_suites', function (Blueprint $table) {
            ...
            $table->string('full_title');//TWAIN v2.3 Compliance - Data Sources v1.2
        ...
        Schema::create('test_cases', function (Blueprint $table) {
            ...
            $table->integer('version_patch');//0
            $table->string('description');//...
            $table->string('full_title');//CN-10 v1.2
         ...
         Schema::create('test_cases_conformance_levels', function (Blueprint $table) {
            ...
            $table->uuid('test_suites_conformance_level_id');
            $table->timestamps();
        });

        Schema::table('test_cases_conformance_levels', function($table) {
            $table->foreign('test_suites_conformance_level_id')->references('id')->on('test_suites_conformance_levels')->onDelete('cascade');
    ...
    public function down()
    {
        ...
        Schema::drop('products_capabilities');
        Schema::drop('products');

        Schema::drop('test_suites_types');
        Schema::drop('test_suites_conformance_levels');
        Schema::drop('test_suites_features');
        Schema::drop('test_suites_scenarios');
        Schema::drop('test_suites_profile_types');
        Schema::drop('test_suites_related_suites');
        Schema::drop('test_suites_roles');
        Schema::drop('test_suites_specification_documents');
        Schema::drop('test_suites_protocols_versions');

        Schema::drop('test_cases_conformance_levels');
        Schema::drop('test_cases_scenarios');
        Schema::drop('test_cases_roles');
        Schema::drop('test_cases_samples');
        Schema::drop('test_cases_features');
        Schema::drop('test_cases_test_steps');
        Schema::drop('test_cases_capabilities');

        Schema::drop('test_suite_test_case');
