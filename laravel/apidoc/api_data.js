define({ "api": [
  {
    ...
    "sampleRequest": [
      {
        "url": "http://hostname/api/profiles/123"
      }
    ],
    "success": {
      "examples": [
        ...
        "Headers": [
          {
            ...
            "type": "String",
            "optional": false,
            "field": "Authorization:Basic",
            "description": "<p>Authorization value (base64_encode(login:password)).</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/v1/testcases/:test_case_id/product/:product_id",
    ...
    "sampleRequest": [
      {
        "url": "http://hostname/api/v1/testcases/123/product/123"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://hostname/api/v1/testcases/123/profiles"
      }
    ],
    "success": {
      "examples": [
