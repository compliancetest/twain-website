...
<xsl:template match="/">
    ...
    <html>
        <head>
            <title>XBRL Sample Instance</title>
            <style type="text/css">
...
<xsl:template name="soapHeaderTable">
    ...
    <h4>Collaboration Info Headers</h4>
    <table border="1" width="800">
        <tr class="header">
            <th>Header Name</th>
            <th>Header Value</th>
    ...
    <h4>Message Properties Headers</h4>
    <table border="1" width="800">
        <tr class="header">
            <th>Header Name</th>
            <th>Header Value</th>
